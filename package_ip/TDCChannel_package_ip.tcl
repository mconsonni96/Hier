...
# =========================== SET PATH =========================================
 set path "/home/mconsonni/Utility_Ip_Core/ip-repo/BeltBus_TDL_Channel_TDC/package_ip"
...
set description "Single Tapped Dealy-Line (TDL) TDC Channel with Dual-Edge Sensitivity (DES)"
...
source [join [list $param_path "create_OC_param.tcl"] ""] -notrace
