...
# Definitional proc to organize Overflow Counter widgets for parameters.
source [file join [file dirname [file dirname [info script]]] package_ip/customization_gui/init_IP_gui/init_OC_gui.tcl]
...
proc init_gui { IPINST } {
  ...
  #set Page_OC "Overflow Counter"
  #init_OC_gui $IPINST $Page_OC
...
source [file join [file dirname [file dirname [info script]]] package_ip/customization_gui/set_IP_gui/set_OC_gui.tcl]
