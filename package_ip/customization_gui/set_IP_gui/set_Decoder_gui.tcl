...
#================================ TYPE_EDGE ====================================
proc update_PARAM_VALUE.TYPE_EDGE_0 { PARAM_VALUE.TYPE_EDGE_0 PARAM_VALUE.NUMBER_OF_TDL PARAM_VALUE.TYPE_TDL_0 } {
	...
	set NUMBER_OF_TDL ${PARAM_VALUE.NUMBER_OF_TDL}
	set values(NUMBER_OF_TDL) [get_property value $NUMBER_OF_TDL]
	set values(TYPE_TDL_0) [get_property value $TYPE_TDL_0]

	if { $values(TYPE_TDL_0) == "O" } {
		set_property value "UP" $TYPE_EDGE_0
	} else {
		set_property value "DN" $TYPE_EDGE_0
	}

	set values(TYPE_EDGE_0) [get_property value $TYPE_EDGE_0]
...
proc update_PARAM_VALUE.TYPE_EDGE_1 { PARAM_VALUE.TYPE_EDGE_1 PARAM_VALUE.NUMBER_OF_TDL PARAM_VALUE.TYPE_TDL_1} {
	...
	set NUMBER_OF_TDL ${PARAM_VALUE.NUMBER_OF_TDL}
	set values(NUMBER_OF_TDL) [get_property value $NUMBER_OF_TDL]
	set values(TYPE_TDL_1) [get_property value $TYPE_TDL_1]

	if { $values(TYPE_TDL_1) == "O" } {
		set_property value "UP" $TYPE_EDGE_1
	} else {
		set_property value "DN" $TYPE_EDGE_1
	}
...
proc update_PARAM_VALUE.TYPE_EDGE_2 { PARAM_VALUE.TYPE_EDGE_2 PARAM_VALUE.NUMBER_OF_TDL PARAM_VALUE.TYPE_TDL_2 } {
	...
	set NUMBER_OF_TDL ${PARAM_VALUE.NUMBER_OF_TDL}
	set values(NUMBER_OF_TDL) [get_property value $NUMBER_OF_TDL]
	set values(TYPE_TDL_2) [get_property value $TYPE_TDL_2]

	if { $values(TYPE_TDL_2) == "O" } {
		set_property value "UP" $TYPE_EDGE_2
	} else {
		set_property value "DN" $TYPE_EDGE_2
	}
...
proc update_PARAM_VALUE.TYPE_EDGE_3 { PARAM_VALUE.TYPE_EDGE_3 PARAM_VALUE.NUMBER_OF_TDL PARAM_VALUE.TYPE_TDL_3 } {
	...
	set NUMBER_OF_TDL ${PARAM_VALUE.NUMBER_OF_TDL}
	set values(NUMBER_OF_TDL) [get_property value $NUMBER_OF_TDL]
	set values(TYPE_TDL_3) [get_property value $TYPE_TDL_3]

	if { $values(TYPE_TDL_3) == "O" } {
		set_property value "UP" $TYPE_EDGE_3
	} else {
		set_property value "DN" $TYPE_EDGE_3
	}
...
proc update_PARAM_VALUE.TYPE_EDGE_4 { PARAM_VALUE.TYPE_EDGE_4 PARAM_VALUE.NUMBER_OF_TDL PARAM_VALUE.TYPE_TDL_4 } {
	...
	set NUMBER_OF_TDL ${PARAM_VALUE.NUMBER_OF_TDL}
	set values(NUMBER_OF_TDL) [get_property value $NUMBER_OF_TDL]
	set values(TYPE_TDL_4) [get_property value $TYPE_TDL_4]

	if { $values(TYPE_TDL_4) == "O" } {
		set_property value "UP" $TYPE_EDGE_4
	} else {
		set_property value "DN" $TYPE_EDGE_4
	}
...
proc update_PARAM_VALUE.TYPE_EDGE_5 { PARAM_VALUE.TYPE_EDGE_5 PARAM_VALUE.NUMBER_OF_TDL PARAM_VALUE.TYPE_TDL_5 } {
	...
	set NUMBER_OF_TDL ${PARAM_VALUE.NUMBER_OF_TDL}
	set values(NUMBER_OF_TDL) [get_property value $NUMBER_OF_TDL]
	set values(TYPE_TDL_5) [get_property value $TYPE_TDL_5]

	if { $values(TYPE_TDL_5) == "O" } {
		set_property value "UP" $TYPE_EDGE_5
	} else {
		set_property value "DN" $TYPE_EDGE_5
	}
...
proc update_PARAM_VALUE.TYPE_EDGE_6 { PARAM_VALUE.TYPE_EDGE_6 PARAM_VALUE.NUMBER_OF_TDL PARAM_VALUE.TYPE_TDL_6 } {
	...
	set NUMBER_OF_TDL ${PARAM_VALUE.NUMBER_OF_TDL}
	set values(NUMBER_OF_TDL) [get_property value $NUMBER_OF_TDL]
	set values(TYPE_TDL_6) [get_property value $TYPE_TDL_6]

	if { $values(TYPE_TDL_6) == "O" } {
		set_property value "UP" $TYPE_EDGE_6
	} else {
		set_property value "DN" $TYPE_EDGE_6
	}
...
proc update_PARAM_VALUE.TYPE_EDGE_7 { PARAM_VALUE.TYPE_EDGE_7 PARAM_VALUE.NUMBER_OF_TDL PARAM_VALUE.TYPE_TDL_7 } {
	...
	set NUMBER_OF_TDL ${PARAM_VALUE.NUMBER_OF_TDL}
	set values(NUMBER_OF_TDL) [get_property value $NUMBER_OF_TDL]
	set values(TYPE_TDL_7) [get_property value $TYPE_TDL_7]

	if { $values(TYPE_TDL_7) == "O" } {
		set_property value "UP" $TYPE_EDGE_7
	} else {
		set_property value "DN" $TYPE_EDGE_7
	}
...
proc update_PARAM_VALUE.TYPE_EDGE_8 { PARAM_VALUE.TYPE_EDGE_8 PARAM_VALUE.NUMBER_OF_TDL PARAM_VALUE.TYPE_TDL_8 } {
	...
	set NUMBER_OF_TDL ${PARAM_VALUE.NUMBER_OF_TDL}
	set values(NUMBER_OF_TDL) [get_property value $NUMBER_OF_TDL]
	set values(TYPE_TDL_8) [get_property value $TYPE_TDL_8]

	if { $values(TYPE_TDL_8) == "O" } {
		set_property value "UP" $TYPE_EDGE_8
	} else {
		set_property value "DN" $TYPE_EDGE_8
	}
...
proc update_PARAM_VALUE.TYPE_EDGE_9 { PARAM_VALUE.TYPE_EDGE_9 PARAM_VALUE.NUMBER_OF_TDL PARAM_VALUE.TYPE_TDL_9 } {
	...
	set NUMBER_OF_TDL ${PARAM_VALUE.NUMBER_OF_TDL}
	set values(NUMBER_OF_TDL) [get_property value $NUMBER_OF_TDL]
	set values(TYPE_TDL_9) [get_property value $TYPE_TDL_9]

	if { $values(TYPE_TDL_9) == "O" } {
		set_property value "UP" $TYPE_EDGE_9
	} else {
		set_property value "DN" $TYPE_EDGE_9
	}
...
proc update_PARAM_VALUE.TYPE_EDGE_10 { PARAM_VALUE.TYPE_EDGE_10 PARAM_VALUE.NUMBER_OF_TDL PARAM_VALUE.TYPE_TDL_10 } {
	...
	set NUMBER_OF_TDL ${PARAM_VALUE.NUMBER_OF_TDL}
	set values(NUMBER_OF_TDL) [get_property value $NUMBER_OF_TDL]
	set values(TYPE_TDL_10) [get_property value $TYPE_TDL_10]

	if { $values(TYPE_TDL_10) == "O" } {
		set_property value "UP" $TYPE_EDGE_10
	} else {
		set_property value "DN" $TYPE_EDGE_10
	}
...
proc update_PARAM_VALUE.TYPE_EDGE_11 { PARAM_VALUE.TYPE_EDGE_11 PARAM_VALUE.NUMBER_OF_TDL PARAM_VALUE.TYPE_TDL_11 } {
	...
	set NUMBER_OF_TDL ${PARAM_VALUE.NUMBER_OF_TDL}
	set values(NUMBER_OF_TDL) [get_property value $NUMBER_OF_TDL]
	set values(TYPE_TDL_11) [get_property value $TYPE_TDL_11]

	if { $values(TYPE_TDL_11) == "O" } {
		set_property value "UP" $TYPE_EDGE_11
	} else {
		set_property value "DN" $TYPE_EDGE_11
	}
...
proc update_PARAM_VALUE.TYPE_EDGE_12 { PARAM_VALUE.TYPE_EDGE_12 PARAM_VALUE.NUMBER_OF_TDL PARAM_VALUE.TYPE_TDL_12 } {
	...
	set NUMBER_OF_TDL ${PARAM_VALUE.NUMBER_OF_TDL}
	set values(NUMBER_OF_TDL) [get_property value $NUMBER_OF_TDL]
	set values(TYPE_TDL_12) [get_property value $TYPE_TDL_12]

	if { $values(TYPE_TDL_12) == "O" } {
		set_property value "UP" $TYPE_EDGE_12
	} else {
		set_property value "DN" $TYPE_EDGE_12
	}
...
proc update_PARAM_VALUE.TYPE_EDGE_13 { PARAM_VALUE.TYPE_EDGE_13 PARAM_VALUE.NUMBER_OF_TDL PARAM_VALUE.TYPE_TDL_13 } {
	...
	set NUMBER_OF_TDL ${PARAM_VALUE.NUMBER_OF_TDL}
	set values(NUMBER_OF_TDL) [get_property value $NUMBER_OF_TDL]
	set values(TYPE_TDL_13) [get_property value $TYPE_TDL_13]

	if { $values(TYPE_TDL_13) == "O" } {
		set_property value "UP" $TYPE_EDGE_13
	} else {
		set_property value "DN" $TYPE_EDGE_13
	}
...
proc update_PARAM_VALUE.TYPE_EDGE_14 { PARAM_VALUE.TYPE_EDGE_14 PARAM_VALUE.NUMBER_OF_TDL PARAM_VALUE.TYPE_TDL_14 } {
	...
	set NUMBER_OF_TDL ${PARAM_VALUE.NUMBER_OF_TDL}
	set values(NUMBER_OF_TDL) [get_property value $NUMBER_OF_TDL]
	set values(TYPE_TDL_14) [get_property value $TYPE_TDL_14]

	if { $values(TYPE_TDL_14) == "O" } {
		set_property value "UP" $TYPE_EDGE_14
	} else {
		set_property value "DN" $TYPE_EDGE_14
	}
...
proc update_PARAM_VALUE.TYPE_EDGE_15 { PARAM_VALUE.TYPE_EDGE_15 PARAM_VALUE.NUMBER_OF_TDL PARAM_VALUE.TYPE_TDL_15} {
	...
	set NUMBER_OF_TDL ${PARAM_VALUE.NUMBER_OF_TDL}
	set values(NUMBER_OF_TDL) [get_property value $NUMBER_OF_TDL]
	set values(TYPE_TDL_15) [get_property value $TYPE_TDL_15]

	if { $values(TYPE_TDL_15) == "O" } {
		set_property value "UP" $TYPE_EDGE_15
	} else {
		set_property value "DN" $TYPE_EDGE_15
	}
...
proc update_MODELPARAM_VALUE.DEBUG_PORT_DECODER { MODELPARAM_VALUE.DEBUG_PORT_DECODER PARAM_VALUE.DEBUG_PORT_DECODER } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.DEBUG_PORT_DECODER}] ${MODELPARAM_VALUE.DEBUG_PORT_DECODER}
}
#===============================================================================
